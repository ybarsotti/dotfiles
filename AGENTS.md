...
This project is indexed by GitNexus as **dotfiles** (1162 symbols, 1219 relationships, 6 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
