...
This project is indexed by GitNexus as **dotfiles** (1231 symbols, 1320 relationships, 9 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
