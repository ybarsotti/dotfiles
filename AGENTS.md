...
This project is indexed by GitNexus as **dotfiles** (570 symbols, 548 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
