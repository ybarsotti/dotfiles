...
This project is indexed by GitNexus as **dotfiles** (1169 symbols, 1227 relationships, 6 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
