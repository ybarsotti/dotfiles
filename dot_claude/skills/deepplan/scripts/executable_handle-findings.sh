#!/usr/bin/env bash
# handle-findings.sh — parse /review-panel report.md, emit JSON list of
# findings classified by severity, with suggested TDD cycle per CRITICAL/HIGH.
#
# Usage:
#   handle-findings.sh <review-panel-run-dir>
#
# Looks for <run-dir>/report.md (the standard /review-panel output).
