...
```bash
/qa-execute --qa-plan ./qa/qa-plan.yaml --url https://app-feature.acme.dev
/qa-execute --qa-plan ./qa/qa-plan.yaml --url https://app.acme.local --commit "$(git rev-parse HEAD)"
/qa-execute --qa-plan ./qa/qa-plan.yaml --url https://app.acme.local --dry-run
```
