...
```bash
/qa-test-plan --plan ./plan.md --url https://app.acme.local
/qa-test-plan --phase plan --plan ./plan.md --ticket PROJ-1234
/qa-test-plan --phase execute --qa-plan ./qa/qa-plan.yaml --url https://app.acme.local
/qa-test-plan --plan ./plan.md --url https://app.acme.local --dry-run
```
